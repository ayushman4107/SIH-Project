...
def test_unsigned_fail_open_finalizes_as_review_without_fake_audit_protection() -> None:
    with tempfile.TemporaryDirectory() as directory:
        ...
        unsigned = Finding(
            ...
            human_readable_reason="Provenance key was unavailable.", evidence={},
        ...
        result = GovernanceModule().finalize(
            ...
            coverage_manifest={"implemented_checks": ["inference_hmac_binding"], "unsupported_attack_classes": []},
            validation_scope={"dataset": "fixture", "architectures": ["resnet18"], "sample_sizes": {"submitted": 1}, "seeds": [42], "status": "partial"},
            model_path=model, model_digest=sha256_file(model), seed=42, ledger=None,
        ...
        assert any("Authenticated logging unavailable" in item for item in coverage["security_limitations"])
